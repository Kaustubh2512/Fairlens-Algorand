...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React2 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef2 = React2.useRef, useEffect2 = React2.useEffect, useMemo2 = React2.useMemo, useDebugValue = React2.useDebugValue;
...
function __flush_internals(relatedVals) {
  const sorted = Array.from(relatedVals).sort((a, b3) => {
    if (a instanceof Derived && a.options.deps.includes(b3)) return 1;
    if (b3 instanceof Derived && b3.options.deps.includes(a)) return -1;
    return 0;
  });
...
var Store = class {
  constructor(initialState, options) {
    ...
    this.subscribe = (listener) => {
      ...
      const unsub = (_b = (_a16 = this.options) == null ? void 0 : _a16.onSubscribe) == null ? void 0 : _b.call(_a16, listener, this);
      return () => {
  ...
  setState(updater) {
    ...
    if ((_a16 = this.options) == null ? void 0 : _a16.updateFn) {
...
var Derived = class _Derived {
  constructor(options) {
    ...
    this.recompute = () => {
      ...
      (_b = (_a16 = this.options).onUpdate) == null ? void 0 : _b.call(_a16);
    };
    ...
    this.subscribe = (listener) => {
      var _a16, _b;
      this.listeners.add(listener);
      const unsub = (_b = (_a16 = this.options).onSubscribe) == null ? void 0 : _b.call(_a16, listener, this);
      return () => {
        this.listeners.delete(listener);
        unsub == null ? void 0 : unsub();
      };
...
// node_modules/@txnlab/use-wallet-react/dist/index.js
var React = __toESM(require_react());

// node_modules/@txnlab/use-wallet/dist/index.js
...
function Sn(r10) {
  let e = (r10 == null ? void 0 : r10.extensions) ?? [], t = {}, s = [];
...
function Jt(r10, e) {
  var _a16;
  let t = (_a16 = e.data.response) == null ? void 0 : _a16.id, s = xn(r10, t);
  if (t && s) {
...
var init_es2 = __esm({
  "../../node_modules/.pnpm/@magic-sdk+provider@29.4.2_localforage@1.10.0/node_modules/@magic-sdk/provider/dist/es/index.mjs"() {
    ...
    K = class r7 {
      ...
      get hasError() {
        var _a17;
        return ((_a17 = this._error) == null ? void 0 : _a17.code) === u.DpopInvalidated && bt(), typeof this._error < "u" && this._error !== null;
      }
      get hasResult() {
    ...
    f2 = class {
      ...
      request(e) {
        ...
        let t = this.overlay.post(y.MAGIC_HANDLE_REQUEST, F2(e)), s = b2((o, i) => {
          ...
          if (i.id === e.id && ((_a17 = i.result) == null ? void 0 : _a17.event)) {
    ...
    Pe = class extends f2 {
      ...
      formatWeb3modalGetInfoResponse() {
        var _a17;
        let e = (_a17 = this.sdk.web3modal.modal.getWalletInfo()) == null ? void 0 : _a17.name, t = this.sdk.web3modal.modal.getAddress();
    ...
    Se = class extends f2 {
      constructor() {
        ...
        __publicField(this, "emit", we("emit"));
        __publicField(this, "eventNames", we("eventNames"));
        __publicField(this, "listeners", we("listeners"));
        __publicField(this, "listenerCount", we("listenerCount"));
      }
      sendAsync(e, t) {
    ...
    Ke = (_a16 = class {
      constructor(e, t) {
        ...
        this.testMode = !!(t == null ? void 0 : t.testMode), this.useStorageCache = !!(t == null ? void 0 : t.useStorageCache), this.endpoint = Je((t == null ? void 0 : t.endpoint) ?? s).origin, this.auth = new ye(this), this.user = new Te(this), this.wallet = new Ie(this), this.nft = new Me(this), this.thirdPartyWallets = new Pe(this), this.rpcProvider = new Se(this);
        let o = Sn.call(this, t);
        this.parameters = ce({ API_KEY: this.apiKey, DOMAIN_ORIGIN: typeof window < "u" && (window == null ? void 0 : window.location) ? window == null ? void 0 : window.location.origin : "", ETH_NETWORK: t == null ? void 0 : t.network, host: Je(this.endpoint).host, sdk: dt[m2.sdkName], version: n, ext: ee(o) ? void 0 : o, locale: (t == null ? void 0 : t.locale) || "en_US", authConfig: (t == null ? void 0 : t.authConfig) ? { ...t.authConfig } : void 0, ...m2.bundleId ? { bundleId: m2.bundleId } : {}, meta: t == null ? void 0 : t.meta }), this.networkHash = wn(this.apiKey, t == null ? void 0 : t.network, ee(o) ? void 0 : o), (t == null ? void 0 : t.deferPreload) || this.preload();
      }
      get overlay() {
        if (!_a16.__overlays__.has(this.parameters)) {
          let e = new m2.ViewController(this.endpoint, this.parameters, this.networkHash);
          e.init(), _a16.__overlays__.set(this.parameters, e);
        }
        return _a16.__overlays__.get(this.parameters);
      }
      async preload() {
        await this.overlay.waitForReady();
      }
    }, __publicField(_a16, "__overlays__", /* @__PURE__ */ new Map()), _a16);
    Nn = 1e3;
    Bt = 60 * Nn;
    Vt = 5 * Bt;
    An = 60 * Bt;
    je = class {
      constructor(e, t, s) {
        ...
        __publicField(this, "heartbeatDebounce", jt(() => {
      ...
      async post(e, t) {
        return De(async (s, n) => {
          ...
          let c = (l) => (u2) => {
            ...
            if (Kt(u2), ((_a17 = w2 == null ? void 0 : w2.payload.error) == null ? void 0 : _a17.message) === "User denied account access.") Re();
    ...
    Ve = class extends f2 {
      constructor() {
        ...
        __publicField(this, "utils", { createPromiEvent: b2, isPromiEvent: $t, encodeJSON: ce, decodeJSON: at, createJsonRpcRequestPayload: p, standardizeJsonRpcRequestPayload: F2, storage: me });
        let e = [this, ...$n(this)];
        Ht.forEach((t) => {
    ...
    He = (_b = class {
    }, __publicField(_b, "Internal", Be), _b);
  }
});
var init_es3 = __esm({
  ...
  "../../node_modules/.pnpm/magic-sdk@29.4.2/node_modules/magic-sdk/dist/es/index.mjs"() {
    ...
    ye2 = class extends je {
      constructor() {
        ...
        __publicField(this, "relayerSrc", Je(`/send?params=${encodeURIComponent(this.parameters)}`, this.endpoint).href);
      }
      init() {
      ...
      async hideOverlay() {
        var _a16;
        let y3 = await this.iframe;
        y3.style.display = "none", y3.style.zIndex = "-1", y3.style.opacity = "0", ((_a16 = this.activeElement) == null ? void 0 : _a16.focus) && this.activeElement.focus(), this.activeElement = null;
      }
      async _post(y3) {
...
function setAccounts(store, { walletId, accounts }) {
  store.setState((state) => {
    ...
    const isActiveAccountConnected = newAccounts.some(
      (account) => {
        var _a16;
        return account.address === ((_a16 = wallet.activeAccount) == null ? void 0 : _a16.address);
      }
    );
...
var BaseWallet = (_a2 = class {
  constructor({
    ...
    __publicField(this, "transactionSigner", async (txnGroup, indexesToSign) => {
    ...
    __publicField(this, "canSignData", false);
    __publicField(this, "signData", async (_data, _metadata) => {
    ...
    __publicField(this, "manageWalletConnectSession", (action, targetWalletId) => {
  ...
  get activeAddress() {
    var _a16;
    return ((_a16 = this.activeAccount) == null ? void 0 : _a16.address) ?? null;
  }
  get activeNetwork() {
    const state = this.store.state;
...
}, __publicField(_a2, "defaultMetadata", { name: "Base Wallet", icon: "" }), _a2);
...
`)}`;
var _a3;
var WalletConnect = (_a3 = class extends BaseWallet {
  constructor({
    id,
    store,
    subscribe,
    ...
    __publicField(this, "connect", async () => {
      ...
      try {
        ...
        (_a16 = this.modal) == null ? void 0 : _a16.closeModal();
      }
    });
    ...
    __publicField(this, "resumeSession", async () => {
      try {
        const state = this.store.state;
        const walletState = state.wallets[this.id];
        if (!walletState) {
    ...
    __publicField(this, "signTransactions", async (txnGroup, indexesToSign) => {
      try {
        if (!this.session) {
  ...
  async initializeClient() {
    ...
    const SignClient = (await import("./use-wallet-KOIK77CZ.js")).SignClient;
  ...
  async initializeModal() {
    ...
    const WalletConnectModal = (await import("./use-wallet-X4TK22TH.js")).WalletConnectModal;
  ...
  get activeChainId() {
    ...
    if (!(network == null ? void 0 : network.caipChainId)) {
...
}, __publicField(_a3, "defaultMetadata", {
  name: "WalletConnect",
  icon: ICON
}), _a3);
...
`)}`;
var _a4;
var BiatecWallet = (_a4 = class extends WalletConnect {
}, __publicField(_a4, "defaultMetadata", {
  name: "BiatecWallet",
  icon: ICON2
}), _a4);
...
`)}`;
var _a5;
var CustomWallet = (_a5 = class extends BaseWallet {
  constructor({
    id,
    store,
    subscribe,
    ...
    __publicField(this, "store");
    __publicField(this, "connect", async (args) => {
      this.logger.info("Connecting...");
      try {
    ...
    __publicField(this, "disconnect", async () => {
      ...
      this.logger.info("Disconnecting...");
      this.onDisconnect();
      await ((_b = (_a16 = this.provider).disconnect) == null ? void 0 : _b.call(_a16));
    });
    __publicField(this, "resumeSession", async () => {
      var _a16, _b;
      try {
        ...
        this.logger.info("Resuming session...");
        const result = await ((_b = (_a16 = this.provider).resumeSession) == null ? void 0 : _b.call(_a16));
    ...
    __publicField(this, "signData", async (data, metadata) => {
    ...
    if (!(options == null ? void 0 : options.provider)) {
...
}, __publicField(_a5, "defaultMetadata", {
  name: "Custom",
  icon: ICON3
}), _a5);
...
`)}`;
var _a6;
var DeflyWallet = (_a6 = class extends BaseWallet {
  constructor({
    id,
    store,
    subscribe,
    ...
    __publicField(this, "connect", async () => {
      ...
      (_a16 = client.connector) == null ? void 0 : _a16.on("disconnect", this.onDisconnect);
  ...
  async initializeClient() {
    this.logger.info("Initializing client...");
    const { DeflyWalletConnect } = await import("./use-wallet-OKXKCWHD.js");
...
}, __publicField(_a6, "defaultMetadata", {
  name: "Defly",
  icon: ICON4
}), _a6);
...
var AVMProvider = class extends BaseWallet {
  constructor(args) {
    super(args);
    __publicField(this, "avmWebClient", null);
    __publicField(this, "avmWebProviderSDK", null);
  ...
  async _initializeAVMWebProviderSDK() {
    if (!this.avmWebProviderSDK) {
      ...
      const module = await import("./use-wallet-HX4F2EWC.js");
...
`)}`;
var _a7;
var DeflyWebWallet = (_a7 = class extends AVMProvider {
  constructor({
    id,
    store,
    subscribe,
...
}, __publicField(_a7, "defaultMetadata", {
...
`)}`;
var _a8;
var ExodusWallet = (_a8 = class extends BaseWallet {
  constructor({
    id,
    store,
    subscribe,
...
}, __publicField(_a8, "defaultMetadata", {
  name: "Exodus",
  icon: ICON6
}), _a8);
...
`)}`;
var _a9;
var KibisisWallet = (_a9 = class extends AVMProvider {
  constructor({
    id,
    store,
    subscribe,
...
}, __publicField(_a9, "defaultMetadata", {
  name: "Kibisis",
  icon: ICON7
}), _a9);
...
`)}`;
var _a10;
var KmdWallet = (_a10 = class extends BaseWallet {
  constructor({
    id,
    store,
    subscribe,
    ...
    __publicField(this, "password", null);
    __publicField(this, "store");
    __publicField(this, "connect", async () => {
      this.logger.info("Connecting...");
      if (!this.client) {
...
}, __publicField(_a10, "defaultMetadata", {
  name: "KMD",
  icon: ICON8
}), _a10);
...
`)}`;
var _a11;
var LuteWallet = (_a11 = class extends BaseWallet {
  constructor({
    id,
    store,
    subscribe,
    ...
    __publicField(this, "canSignData", true);
    __publicField(this, "signData", async (data, metadata) => {
      try {
        this.logger.debug("Signing data...", { data, metadata });
        const client = this.client || await this.initializeClient();
  ...
  async initializeClient() {
    var _a16;
    this.logger.info("Initializing client...");
    const module = await import("./use-wallet-GDYVANK7.js");
    const LuteConnect = module.default;
    const client = new LuteConnect((_a16 = this.options) == null ? void 0 : _a16.siteName);
    this.client = client;
    this.logger.info("Client initialized");
    return client;
  }
...
}, __publicField(_a11, "defaultMetadata", {
  name: "Lute",
  icon: ICON9
}), _a11);
...
`)}`;
var _a12;
var MagicAuth = (_a12 = class extends BaseWallet {
  constructor({
    id,
    store,
    subscribe,
    ...
    __publicField(this, "connect", async (args) => {
      this.logger.info("Connecting...");
      if (!(args == null ? void 0 : args.email) || typeof args.email !== "string") {
    ...
    __publicField(this, "disconnect", async () => {
      ...
      this.onDisconnect();
      const client = this.client || await this.initializeClient();
      this.logger.info(`Logging out ${((_a16 = this.userInfo) == null ? void 0 : _a16.email) || "user"}...`);
...
}, __publicField(_a12, "defaultMetadata", {
  name: "Magic",
  icon: ICON10
}), _a12);
...
`)}`;
var _a13;
var MnemonicWallet = (_a13 = class extends BaseWallet {
  constructor({
    id,
    store,
    subscribe,
...
}, __publicField(_a13, "defaultMetadata", {
  name: "Mnemonic",
  icon: ICON11
}), _a13);
...
`)}`;
var _a14;
var PeraWallet = (_a14 = class extends BaseWallet {
  constructor({
    id,
    store,
    subscribe,
  ...
  async initializeClient() {
    this.logger.info("Initializing client...");
    const { PeraWalletConnect } = await import("./@perawallet_connect.js");
...
}, __publicField(_a14, "defaultMetadata", {
  name: "Pera",
  icon: ICON12
}), _a14);
...
`)}`;
var _a15;
var W3Wallet = (_a15 = class extends BaseWallet {
  constructor({
    id,
    store,
    subscribe,
...
}, __publicField(_a15, "defaultMetadata", {
  name: "W3 Wallet",
  icon: ICON13
}), _a15);
...
var WalletManager = class {
  constructor({
    ...
    __publicField(this, "_clients", /* @__PURE__ */ new Map());
    __publicField(this, "baseNetworkConfig");
    __publicField(this, "store");
    __publicField(this, "subscribe");
    __publicField(this, "options");
    __publicField(this, "logger");
    ...
    __publicField(this, "setActiveNetwork", async (networkId) => {
    ...
    const activeNetwork = this.options.resetNetwork ? defaultNetwork : (persistedState == null ? void 0 : persistedState.activeNetwork) || defaultNetwork;
  ...
  determineLogLevel(options) {
    ...
    return (options == null ? void 0 : options.logLevel) !== void 0 ? options.logLevel : 2;
  }
  // ---------- Store ------------------------------------------------- //
  get algodClient() {
  ...
  async resumeSessions() {
    try {
      const promises = this.wallets.map((wallet) => wallet == null ? void 0 : wallet.resumeSession());
  ...
  async disconnect() {
    const promises = this.wallets.filter((wallet) => wallet.isConnected).map((wallet) => wallet == null ? void 0 : wallet.disconnect());
    await Promise.all(promises);
  }
  // ---------- Network ----------------------------------------------- //
  initNetworkConfig(baseConfig, persistedState) {
    this.logger.info("Initializing network configuration...");
    const customConfigs = (persistedState == null ? void 0 : persistedState.customNetworkConfigs) || {};
    const config = {};
    for (const [networkId, baseNetworkConfig] of Object.entries(baseConfig)) {
      ...
      config[networkId] = {
        ...
        algod: {
          ...
          ...(customNetworkConfig == null ? void 0 : customNetworkConfig.algod) || {}
        }
      };
    }
  ...
  resetNetworkConfig(networkId) {
    ...
    const persistedState = this.loadPersistedState();
    if (persistedState == null ? void 0 : persistedState.customNetworkConfigs) {
...
var WalletProvider = ({ manager, children }) => {
  ...
  return (0, import_jsx_runtime.jsx)(WalletContext.Provider, { value: { manager, algodClient, setAlgodClient }, children });
};
var useNetwork = () => {
...
var useWallet = () => {
  ...
  const transformToWallet = React.useCallback(
    (wallet) => {
      ...
      return {
        ...
        accounts: (walletState == null ? void 0 : walletState.accounts) ?? [],
        activeAccount: (walletState == null ? void 0 : walletState.activeAccount) ?? null,
  ...
  const activeWalletAccounts = (activeWallet == null ? void 0 : activeWallet.accounts) ?? null;
  const activeWalletAddresses = (activeWalletAccounts == null ? void 0 : activeWalletAccounts.map((account) => account.address)) ?? null;
  const activeAccount = (activeWallet == null ? void 0 : activeWallet.activeAccount) ?? null;
  const activeAddress = (activeAccount == null ? void 0 : activeAccount.address) ?? null;
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=@txnlab_use-wallet-react.js.map
